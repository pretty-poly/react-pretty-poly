...
const DashboardExample: React.FC = () => {
  ...
  const recentActivity = [
    { type: 'order', message: 'New order #1847', time: '2 min ago', status: 'success' },
    { type: 'user', message: 'User registration', time: '5 min ago', status: 'info' },
    { type: 'payment', message: 'Payment failed #1846', time: '8 min ago', status: 'error' },
    { type: 'order', message: 'Order shipped #1845', time: '12 min ago', status: 'success' }
  ]
    ...
    <div style={{ height: '100vh', fontFamily: 'system-ui, sans-serif' }}>
      ...
      >
        ...
        >
          ...
          <div className="relative h-64 bg-gray-50 rounded-lg flex items-end justify-center p-4">
            <div className="flex items-end space-x-2 w-full max-w-md">
              {[65, 45, 78, 52, 89, 34, 67, 91, 23, 78, 56, 89].map((height, index) => (
                <div
                  key={index}
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-gray-400 text-sm">Interactive Chart Component</div>
            </div>
          </div>
        </Block>
        ...
        >
          ...
          <Divider targetId="charts-area" position="end" />
        ...
        >
          ...
          <div className="grid grid-cols-4 gap-3">
            ...
            <button className="p-3 bg-green-50 hover:bg-green-100 rounded-lg text-center transition-colors">
              ...
              <div className="text-xs text-green-700 font-medium">Billing</div>
            </button>
            ...
            <button className="p-3 bg-orange-50 hover:bg-orange-100 rounded-lg text-center transition-colors">
              ...
              <div className="text-xs text-orange-700 font-medium">Settings</div>
            </button>
          </div>

          <div className="mt-6">
            <h4 className="text-xs font-medium text-gray-900 mb-3">Recent Orders</h4>
            <div className="space-y-2">
              <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                ...
                <div className="text-xs font-medium text-green-600">$89.99</div>
              </div>
              <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                <div className="text-xs">
                ...
                <div className="text-xs font-medium text-green-600">$156.50</div>
              </div>
            </div>
          </div>
        </Block>

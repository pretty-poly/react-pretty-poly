    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px', maxWidth: '600px' }}>
        ...
        <p style={{
          ...
          Interactive examples showcasing polymorphic grid layouts designed for full-page applications
        </p>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <strong>💡 Pro Tip:</strong> Each example runs in full-page mode. Try resizing panels by dragging dividers and double-clicking to collapse/expand sections.
        </div>
      </div>
    </div>
  )
